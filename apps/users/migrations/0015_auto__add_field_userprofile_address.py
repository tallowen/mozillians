...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile', 'address', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['locations.Address'], unique=True, null=True), keep_default=False)
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['locations.Address']", 'unique': 'True', 'null': 'True'}),
